...
client.connect(url).then(client => 
      client.db(dbName).collection("rooms").find().toArray()).then(cols => console.log("Collections", cols)) // Returns a promise that will resolve to the list of the collections 
     // )
